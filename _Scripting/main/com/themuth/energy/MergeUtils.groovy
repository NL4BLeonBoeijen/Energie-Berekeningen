...
//            sheet.addCell(new Formula(9, nCountLine, "COUNT(J2:J$nToLine)"))
    ...
    Object getColumn(iObject) {
        switch (iObject.key.toString()) {
            ...
            case "CONSUMPTION_KWH_LOW": return [2, "L", "ConsumptionLow"]
            case "CONSUMPTION_KWH_HIGH": return [3, "L", "ConsumptionHigh"]
            case "PRODUCTION_KWH_LOW": return [4, "L", "ProductionLow"]
            case "PRODUCTION_KWH_HIGH": return [5, "L", "ProductionHigh"]
            case "CONSUMPTION_DELTA_KWH": return [6, "L", "ConsumptionDelta"]
            case "PRODUCTION_DELTA_KWH": return [7, "L", "ProductionDelta"]
            ...
            case "RETURN_FOR_CONSUMPTION": return [13, "N", "ConsumptionReturn"]
            case "RETURN_FOR_PRODUCTION": return [14, "N", "ProductionReturn"]
            case "PAY_FOR_CONSUMPTION": return [12, "N", "ConsumptionPay"]
            case "TIMESTAMP_UTC": return [16, "L", "UTC"]
            case "CONSUMPTION_GAS_M3": return [17, "L", "Gas M3"]
            case "CONSUMPTION_GAS_DELTA_M3": return [18, "L", "Gas M3 Delta"]
        }
    }
}
